...
export function calculateMenuPosition({ toggler, viewport, menu, alignment = ["right", "bottom"], spacing = 0, offset = 0, topLevelMenu = true, }) {
    ...
    const [primaryCoordinateDirection, primaryCoordinate] = calculatePositionForDirection(Object.assign(Object.assign({}, sharedArguments), { direction: directionPreferredPrimary, isPrimaryDimension: true }));
    const [secondaryCoordinateDirection, secondaryCoordinate] = calculatePositionForDirection(Object.assign(Object.assign({}, sharedArguments), { direction: directionPrefferedSecondary, isPrimaryDimension: false }));
    const coordinates = {
...
function calculatePositionForDirection({ toggler, viewport, menu, direction, spacing, offset, isPrimaryDimension, }) {
