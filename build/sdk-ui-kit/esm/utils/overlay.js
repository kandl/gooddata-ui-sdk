...
function getDefaultViewportRegion(ignoreScrollOffsets) {
    const region = elementRegion(document.body);
    return {
...
function getRegionOffset(region, ratio, direction = 1) {
    return {
...
function subtractOffset(position, offset) {
    return {
        x: position.x - offset.x,
        y: position.y - offset.y,
    };
 ...
 */
function getGlobalPosition(bodyRegion, targetRegion, selfRegion, alignPoint) {
 ...
 */
function getPositionedSelfRegion({ targetRegion, selfRegion, bodyRegion, alignPoint, }) {
 ...
 * align points
 */
export function getOptimalAlignmentForRegion({ boundaryRegion, targetRegion, selfRegion, alignPoints, }) {
    const bodyRegion = elementRegion(document.body);
 ...
 */
export function getOptimalAlignment({ targetRegion, selfRegion, ignoreScrollOffsets, alignPoints, getViewportRegion = getDefaultViewportRegion, getDocumentRegion = getDefaultDocumentRegion, }) {
