...
import { newWidthForAllColumnsForMeasure, newWidthForAttributeColumn, setNewWidthForSelectedColumns, PivotTable, } from "@gooddata/sdk-ui-pivot";
import { PivotTableWithTwoMeasuresAndSingleRowAttr, PivotTableWithSingleMeasureAndTwoRowsAndCols, } from "./base.js";
...
const justManualResizing = scenariosFor("PivotTable", PivotTable)
...
const withColumnAutoresize = scenariosFor("PivotTable", PivotTable)
    ...
    .addCustomizedScenarios(justManualResizing, copyWithModifiedProps((props) => {
    props.config.columnSizing.defaultWidth = "autoresizeAll";
    return props;
}));
const withGrowToFit = scenariosFor("PivotTable", PivotTable)
...
const withAllAutoresizing = scenariosFor("PivotTable", PivotTable)
...
//# sourceMappingURL=manualSizing.js.map