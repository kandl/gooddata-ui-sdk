...
const legendScenarios = scenariosFor("BubbleChart", BubbleChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "legend position" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("legend position", BubbleChartWithAllMeasuresAndAttribute, legendCustomizer);
const dataLabelScenarios = scenariosFor("BubbleChart", BubbleChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "data labels" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("data labels", BubbleChartWithAllMeasuresAndAttribute, dataLabelCustomizer);
const legendResponziveScenarios = responsiveScenarios("BubbleChart", ScenarioGroupNames.LegendResponsive, BubbleChart, BubbleChartWithAllMeasuresAndAttribute, legendResponsiveSizeVariants, false, legendResponsiveVariants);
