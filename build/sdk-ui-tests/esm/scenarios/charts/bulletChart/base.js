...
export default scenariosFor("BulletChart", BulletChart)
    ...
    .addScenario("primary, target and comparative measures with two viewBy", BulletChartWithAllMeasuresAndTwoViewBy)
    .addScenario("primary with two viewBy dates", BulletChartWithPrimaryMeasureAndTwoViewByDates)
    .addScenario("primary, target and comparative measures with two viewBy dates", BulletChartWithAllMeasuresMeasuresAndTwoViewByDates);
