...
import { ColumnChartWithArithmeticMeasuresAndViewBy, ColumnChartWithTwoMeasuresAndTwoViewBy, ColumnChartWithTwoMeasuresAndViewBy, } from "./base.js";
import { ScenarioGroupNames } from "../_infra/groupNames.js";
const singleAxisNameConfig = scenariosFor("ColumnChart", ColumnChart)
    ...
    .addScenarios("single axis name customization", ColumnChartWithTwoMeasuresAndViewBy, axisNameCustomization);
const dualAxisNameConfig = scenariosFor("ColumnChart", ColumnChart)
    .withGroupNames(...ScenarioGroupNames.Axes)
    .withVisualTestConfig({
    ...
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("dual axis name customization", {
...
const axisConfig = scenariosFor("ColumnChart", ColumnChart)
    .withGroupNames(...ScenarioGroupNames.Axes)
