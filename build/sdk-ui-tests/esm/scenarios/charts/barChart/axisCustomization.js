...
import { BarChartWithArithmeticMeasuresAndViewBy, BarChartWithTwoMeasuresAndTwoViewBy, BarChartWithTwoMeasuresAndViewBy, } from "./base.js";
import { measureLocalId } from "@gooddata/sdk-model";
import { ReferenceMd, ReferenceMdExt } from "@gooddata/reference-workspace";
import { axisRotationVariants } from "../_infra/axisRotationVariants.js";
import { ScenarioGroupNames } from "../_infra/groupNames.js";
const singleAxisNameConfig = scenariosFor("BarChart", BarChart)
...
const dualAxisNameConfig = scenariosFor("BarChart", BarChart)
    .withGroupNames(...ScenarioGroupNames.Axes)
    .withVisualTestConfig({
...
const dualAxisLabelRotation = scenariosFor("BarChart", BarChart)
    .withGroupNames(...ScenarioGroupNames.Axes)
    .withVisualTestConfig({
    ...
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("dual axis label rotation", {
...
const axisConfig = scenariosFor("BarChart", BarChart)
    .withGroupNames(...ScenarioGroupNames.Axes)
