...
const legendScenarios = scenariosFor("PyramidChart", PyramidChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "legend position" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("legend position - two measures", PyramidChartWithTwoMeasures, legendCustomizer)
    .addScenarios("legend position - single measure and viewBy", PyramidChartWithMeasureAndViewBy, legendCustomizer);
const dataLabelScenarios = scenariosFor("PyramidChart", PyramidChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "data labels" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("data labels", PyramidChartWithMeasureAndViewBy, dataLabelCustomizer);
const chartAlignmentScenarios = scenariosFor("PyramidChart", PyramidChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
...
const legendResponziveScenarios = responsiveScenarios("PyramidChart", ScenarioGroupNames.LegendResponsive, PyramidChart, PyramidChartWithMeasureAndViewBy, legendResponsiveSizeVariants, false, legendResponsiveVariants);
