...
export const initCmd = program
    ...
    .argument("[app-name]", "Name of the application to create. Application name will be used to " +
    "create a new subdirectory for the project. The program expects that the subdirectory does not exist")
    .option("--language <language>", "Programming language to use for app. Either TypeScript (ts) or JavaScript (js)")
    ...
    .option("--target-dir <path>", "Path to the directory to create the app in. If not " +
