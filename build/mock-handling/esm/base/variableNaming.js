 ...
 */
export function createUniqueVariableName(title, scope = {}) {
 ...
 * @param scope - uniqueness scope
 */
export function createUniqueVariableNameForIdentifier(id, scope = {}) {
 ...
 * @param scope - uniqueness scope
 */
function createUniqueName(name, scope) {
    let uniqueName = name;
    let num = 1;
