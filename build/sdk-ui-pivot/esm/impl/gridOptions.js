...
import { COLUMN_ATTRIBUTE_COLUMN, DEFAULT_AUTOSIZE_PADDING, DEFAULT_ROW_HEIGHT, MEASURE_COLUMN, COLUMN_TOTAL, COLUMN_SUBTOTAL, ROW_ATTRIBUTE_COLUMN, ROW_MEASURE_COLUMN, MIXED_HEADERS_COLUMN, MIXED_VALUES_COLUMN, } from "./base/constants.js";
import { columnAttributeTemplate, measureColumnTemplate, rowAttributeTemplate, rowMeasureTemplate, mixedValuesColsTemplate, totalSubTotalColumnTemplate, mixedHeadersTemplate, } from "./structure/colDefTemplates.js";
export function createGridOptions(table, tableMethods, props) {
     ...
     */
    const extraTotalsBuffer = ((_a = props.config) === null || _a === void 0 ? void 0 : _a.menu) ? 10 : 0;
    ...
    const hideEmptyHeader = tableMethods.getColumnHeadersPosition() === "left" && table.tableDescriptor.isTransposed();
    return {
        // Initial data
        ...
        defaultColDef: {
            ...
            headerComponentParams: Object.assign({ menu: tableMethods.getMenuConfig, enableSorting: true }, commonHeaderComponentParams),
            minWidth: MIN_WIDTH,
            sortable: true,
            resizable: true,
        },
        defaultColGroupDef: {
            ...
            headerGroupComponentParams: Object.assign({ menu: tableMethods.getMenuConfig }, commonHeaderComponentParams),
        },
