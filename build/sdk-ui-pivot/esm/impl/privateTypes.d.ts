...
import { ColumnResizedCallback, DefaultColumnWidth, IMenu, ColumnHeadersPosition, MeasureGroupDimension } from "../publicTypes.js";
...
import { AgGridEvent, BodyScrollEvent, ColumnResizedEvent, GridOptions, GridReadyEvent, SortChangedEvent, PinnedRowDataChangedEvent } from "@ag-grid-community/all-modules";
 ...
 */
export type TableMethods = TableDataCallbacks & TableLegacyCallbacks & TableConfigAccessors & TableAgGridCallbacks & TableMenuCallbacks;
