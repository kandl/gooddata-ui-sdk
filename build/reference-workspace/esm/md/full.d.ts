 ...
 */
export declare const Sort: IAttribute;
/**
 ...
 * Metric Type: MAQL Metric
 */
export declare const IntermediateSumVelocityAndValue: IMeasure<IMeasureDefinition>;
/**
 * Metric Title: Negative Sum Duration
 * Metric ID: abTsUy7k6OIl
 * Metric Type: MAQL Metric
 */
export declare const NegativeSumDuration: IMeasure<IMeasureDefinition>;
/**
 * Metric Title: Negative Sum Probability
 * Metric ID: acEsTPZKdqzb
 * Metric Type: MAQL Metric
 */
export declare const NegativeSumProbability: IMeasure<IMeasureDefinition>;
/**
 ...
 * Metric Type: MAQL Metric
 */
export declare const TotalSum: IMeasure<IMeasureDefinition>;
/**
...
export declare const Insights: {
     ...
     */ AreaChartWithAllBuckets: string;
};
