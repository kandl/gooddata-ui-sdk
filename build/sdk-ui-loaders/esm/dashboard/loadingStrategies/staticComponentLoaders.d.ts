 ...
 * @internal
 */
export declare function staticDashboardEngineLoader(_dashboard: IDashboardWithReferences | undefined): Promise<IDashboardEngine>;
/**
 ...
 * @internal
 */
export declare function noopDashboardPluginLoader(_ctx: DashboardContext, _dashboard: IDashboardWithReferences | undefined): Promise<LoadedPlugin[]>;
/**
 ...
 * @internal
 */
export declare function noopDashboardBeforeLoad(_ctx: DashboardContext, _dashboard: IDashboardWithReferences | undefined): Promise<void>;
