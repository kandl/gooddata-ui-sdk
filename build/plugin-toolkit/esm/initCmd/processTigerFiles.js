 ...
 */
async function processTigerFile(tigerVersion, isTigerBackend) {
    if (isTigerBackend) {
 ...
 * @param isTigerBackend - flag indicating if the backend to use is tiger
 */
export async function processTigerFiles(initialPath, isTigerBackend) {
...
//# sourceMappingURL=processTigerFiles.js.map