...
import { newAxios, tigerClientFactory, setAxiosAuthorizationToken, } from "@gooddata/api-client-tiger";
/**
 ...
 */
export function createTigerClient(hostname, token, username, password) {
