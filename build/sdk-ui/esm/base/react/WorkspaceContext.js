 ...
 * @public
 */
export const WorkspaceProvider = ({ children, workspace }) => {
...
export function withWorkspace(Component) {
    const ComponentWithInjectedWorkspace = (props) => {
        return (React.createElement(WorkspaceContext.Consumer, null, (workspace) => { var _a; return React.createElement(Component, Object.assign({}, props, { workspace: (_a = props.workspace) !== null && _a !== void 0 ? _a : workspace })); }));
    };
