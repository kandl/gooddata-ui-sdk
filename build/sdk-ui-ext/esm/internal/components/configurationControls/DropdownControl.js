...
class DropdownControl extends React.PureComponent {
    ...
    render() {
        const { disabled, labelText, value, width, items, showDisabledMessage, disabledMessageAlignPoints, customListItem: ListItem, intl, } = this.props;
        const selectedItem = this.getSelectedItem(value) || {};
        return (React.createElement(DisabledBubbleMessage, { showDisabledMessage: showDisabledMessage, alignPoints: disabledMessageAlignPoints },
            React.createElement("div", { className: "adi-properties-dropdown-container" },
                ...
                React.createElement("label", { className: "adi-bucket-inputfield gd-input gd-input-small" },
                    React.createElement(Dropdown, { renderButton: ({ isOpen, toggleDropdown }) => {
                            ...
                            return (React.createElement(DropdownList, { width: width, isMobile: isMobile, items: items, renderItem: ({ item }) => (React.createElement(ListItem, { title: item.title, isSelected: item.value === selectedItem.value, onClick: () => {
                                        this.onSelect(item);
                                        closeDropdown();
