...
class InputControl extends React.Component {
    ...
    render() {
        const { disabled, labelText, placeholder, showDisabledMessage, disabledMessageId, intl, type, maxLength, } = this.props;
        return (React.createElement(DisabledBubbleMessage, { showDisabledMessage: showDisabledMessage, messageId: disabledMessageId },
            React.createElement("label", { className: "adi-bucket-inputfield s-adi-bucket-inputfield gd-input gd-input-small" },
                React.createElement("span", { className: "input-label-text" }, getTranslation(labelText, intl)),
                React.createElement("input", { ref: (input) => (this.inputRef = input), className: this.getInputClassNames(), value: this.state.value, placeholder: getTranslation(placeholder, intl), disabled: disabled, onKeyPress: this.onKeyPress, onBlur: this.onBlur, onChange: this.onValueChanged, maxLength: type === "number" ? MAX_NUMBER_LENGTH : maxLength }))));
    }
    getInputClassNames() {
