...
import { bucketsItems, insightBucket, insightBuckets, newAttributeSort, } from "@gooddata/sdk-model";
...
import { AREA_CHART_SUPPORTED_PROPERTIES, OPTIONAL_STACKING_PROPERTIES, } from "../../../constants/supportedProperties.js";
import { AREA_UICONFIG_WITH_MULTIPLE_DATES, DEFAULT_AREA_UICONFIG, MAX_CATEGORIES_COUNT, MAX_STACKS_COUNT, MAX_VIEW_COUNT, } from "../../../constants/uiConfig.js";
import { configureOverTimeComparison, configurePercent } from "../../../utils/bucketConfig.js";
import { getAllAttributeItemsWithPreference, getAllCategoriesAttributeItems, getDateItems, getFilteredMeasuresForStackedCharts, getStackItems, removeDivergentDateItems, isDateBucketItem, isNotDateBucketItem, removeAllArithmeticMeasuresFromDerived, removeAllDerivedMeasures, sanitizeFilters, getMainDateItem, getBucketItems, } from "../../../utils/bucketHelper.js";
import { getReferencePointWithSupportedProperties, removeImmutableOptionalStackingProperties, } from "../../../utils/propertiesHelper.js";
...
export class PluggableAreaChart extends PluggableBaseChart {
    ...
    isContinuousLineControlDisabled(insight) {
        ...
        if (typeof isStackingMeasures === "undefined") {
            ...
            return (stackBuckets === null || stackBuckets === void 0 ? void 0 : stackBuckets.items.length) > 0 || ((_c = measuresBuckets === null || measuresBuckets === void 0 ? void 0 : measuresBuckets.items) === null || _c === void 0 ? void 0 : _c.length) > 1;
        }
