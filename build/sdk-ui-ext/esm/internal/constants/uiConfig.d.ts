...
export declare const DEFAULT_WATERFALL_UICONFIG: IUiConfig;
export declare const WATERFALL_UICONFIG_WITH_ONE_METRIC: IUiConfig;
export declare const WATERFALL_UICONFIG_WITH_MULTIPLE_METRICS: IUiConfig;
...
export declare const DEFAULT_SANKEY_UI_CONFIG: IUiConfig;
