...
export const pushpinSizeDropdownItems = [
...
export const pushpinViewportDropdownItems = [
...
export const rotationDropdownItems = [
...
export const legendPositionDropdownItems = [
    { title: messages.autoDefault.id, value: "auto" },
    { type: "separator" },
...
export const orientationDropdownItems = [
...
export const totalLabelsDropdownItems = [
...
export const dataPointsDropdownLabels = [
...
export const xAxisPositionDropdownItems = [
    { title: messages.autoDefault.id, value: "auto" },
    { type: "separator" },
    {
...
export const yAxisPositionDropdownItems = [
    { title: messages.autoDefault.id, value: "auto" },
    { type: "separator" },
    {
...
export const comparisonPositionDropdownItems = [
