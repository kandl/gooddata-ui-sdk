...
import { getItemsCount, getItemsLocalIdentifiers, getMeasureItems, getAllMeasuresShowOnSecondaryAxis, getStackItems, } from "./bucketHelper.js";
...
export function getPivotTableProperties(settings, properties) {
    ...
    return Object.assign(Object.assign({}, (enablePivotTableTransposition === true
        ? {
