...
import { bucketItems, bucketsFind, insightBuckets, insightProperties, } from "@gooddata/sdk-model";
...
export function isSetColumnHeadersPositionToLeftAllowed(insight) {
    var _a;
    ...
    return hasColumns && !hasRows && measureGroupDimension === "rows";
}
