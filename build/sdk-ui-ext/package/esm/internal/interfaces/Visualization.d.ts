...
import { ISettings, ITheme, IColorPalette, IInsight, IInsightDefinition, ITotal, ObjRef, VisualizationProperties, IExecutionConfig, LocalIdRef, ISortItem } from "@gooddata/sdk-model";
import { ChartType, GoodDataSdkError, ExplicitDrill, IDrillEvent, ILocale, IPushData, IVisualizationCallbacks, OverTimeComparisonType, VisualizationEnvironment } from "@gooddata/sdk-ui";
...
/** @deprecated Use ElementSelectorFunction instead */
export type ElementSelectorString = string;
export interface IVisConstruct {
    backend: IAnalyticalBackend;
    projectId: string;
    element: ElementSelectorString | ElementSelectorFunction;
    configPanelElement: ElementSelectorString | ElementSelectorFunction;
