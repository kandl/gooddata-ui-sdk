...
export function normalizeInsight(insight) {
    ...
    const o2nMap = flow(toPairs, map(([normalized, original]) => [original, normalized]), fromPairs)(n2oMap);
    ...
    return flow((i) => insightSetBuckets(i, processedBuckets), (i) => insightSetFilters(i, normalized.filters), (i) => insightSetSorts(i, normalized.sortBy), (i) => insightSetProperties(i, processedProperties))(insight);
}
