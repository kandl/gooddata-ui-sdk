...
export function setScatterPlotUiConfig(referencePoint, intl, visualizationType) {
    ...
    set(referencePointConfigured, [UICONFIG, BUCKETS, BucketNames.SECONDARY_MEASURES, "icon"], scatterMeasuresYIcon);
