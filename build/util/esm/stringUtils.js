...
export function simplifyText(value) {
    var _a, _b;
    const s = (_b = (_a = value === null || value === void 0 ? void 0 : value.toString) === null || _a === void 0 ? void 0 : _a.call(value)) !== null && _b !== void 0 ? _b : "";
 ...
 * @internal
 */
export function hashCodeString(value) {
    if (!(value === null || value === void 0 ? void 0 : value.length)) {
        return 0;
    }
    const chars = value.split("");
    const hashCode = chars.reduce((hashCode, char) => {
