 ...
 */
export const axios = globalAxios.create(_CONFIG);
/**
 ...
 * @public
 */
export function setGlobalAuthorizationToken(token) {
    _TOKEN = token;
}
/**
 ...
 * @public
 */
export function setAxiosAuthorizationToken(axios, token) {
    if (!token) {
 ...
 * @public
 */
export function newAxiosRequestConfig(baseUrl, headers) {
 ...
 * @public
 */
export function newAxios(baseUrl, headers) {
