import { IAnalyticalBackendConfig, IDashboardWithReferences, ValidationContext, IWorkspaceDescriptor } from "@gooddata/sdk-backend-spi";
import { IColorPalette, IExecutionDefinition, IInsight, IVisualizationClass, ObjRef, IUser, IWorkspaceUser, IDateFilterConfig, IWidgetAlert, CatalogItem, ICatalogGroup, ICatalogAttribute, ICatalogFact, ICatalogMeasure, ICatalogDateDataset, IAttributeDisplayFormMetadataObject, IAttributeElement, ISettings, IWorkspaceUserGroup, ITheme, AccessGranteeDetail, IAttributeFilter, IDateFilter, IMeasure, Identifier, IAvailableAccessGrantee, ICatalogAttributeHierarchy } from "@gooddata/sdk-model";
/**
 * @internal
 */
