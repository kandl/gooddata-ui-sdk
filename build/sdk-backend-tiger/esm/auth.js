 ...
 * @public
 */
export class TigerAuthProviderBase {
...
export class TigerTokenAuthProvider extends TigerAuthProviderBase {
    constructor(apiToken, notAuthenticatedHandler) {
        super();
...
export class TigerJwtAuthProvider extends TigerTokenAuthProvider {
     ...
     */
    constructor(jwt, notAuthenticatedHandler, tokenIsAboutToExpireHandler, secondsBeforeTokenExpirationToCallReminder = DEFAULT_EXPIRATION_REMINDER_IN_SECONDS) {
        super(jwt, notAuthenticatedHandler);
        this.jwt = jwt;
        this.tokenIsAboutToExpireHandler = tokenIsAboutToExpireHandler;
         ...
         */
        this.updateJwt = (jwt, secondsBeforeTokenExpirationToCallReminder = DEFAULT_EXPIRATION_REMINDER_IN_SECONDS) => {
    ...
    startReminder(jwt) {
        if (this.tokenIsAboutToExpireHandler === undefined ||
        ...
        () => this.tokenIsAboutToExpireHandler((newJwt) => this.updateJwt(newJwt)), computeExpirationReminderTimeout(jwt, this.secondsBeforeTokenExpirationToCallReminder, Date.now()));
    }
}
/**
...
export function createTigerAuthenticationUrl(backend, authenticationFlow, location) {
    ...
    let returnAddress = `${(_a = location.pathname) !== null && _a !== void 0 ? _a : ""}${(_b = location.search) !== null && _b !== void 0 ? _b : ""}${(_c = location.hash) !== null && _c !== void 0 ? _c : ""}`;
