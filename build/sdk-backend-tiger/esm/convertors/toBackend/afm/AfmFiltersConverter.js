...
export function convertAfmFilters(afmMeasures, afmFilters) {
    ...
    const transformedFilters = afmFilters.map((filter) => {
        ...
        if (isMeasureValueFilter(filter)) {
            const [filteredMeasure, applyOnResult] = getActualFilteredMeasureInfo(computeRatioMeasureNumerators, filter.measureValueFilter.measure);
            ...
            const [filteredMeasure, applyOnResult] = getActualFilteredMeasureInfo(computeRatioMeasureNumerators, filter.rankingFilter.measure);
