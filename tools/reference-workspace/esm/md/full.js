 ...
 */
export const ActivityType = newAttribute("label.activity.activitytype");
/**
 * Attribute Title: Department
 * Attribute ID: attr.owner.department
 */
export const Department = newAttribute("label.owner.department");
/**
 * Attribute Title: Forecast Category
 * Attribute ID: attr.opportunitysnapshot.forecastcategory
 */
export const ForecastCategory = newAttribute("label.opportunitysnapshot.forecastcategory");
/**
 * Attribute Title: Is Active?
 * Attribute ID: attr.stage.isactive
 */
export const IsActive = newAttribute("label.stage.isactive");
/**
 * Attribute Title: Is Closed?
 * Attribute ID: attr.activity.isclosed
 */
export const IsClosed = newAttribute("label.activity.isclosed");
/**
 * Attribute Title: Is Closed?
 * Attribute ID: attr.stage.isclosed
 */
export const IsClosed_1 = newAttribute("label.stage.isclosed");
/**
 * Attribute Title: Is Task?
 * Attribute ID: attr.activity.istask
 */
export const IsTask = newAttribute("label.activity.istask");
/**
 * Attribute Title: Is Won?
 * Attribute ID: attr.stage.iswon
 */
export const IsWon = newAttribute("label.stage.iswon");
/**
 * Attribute Title: Opp. Snapshot
 * Attribute ID: attr.opportunitysnapshot.id
 */
export const OppSnapshot = newAttribute("label.opportunitysnapshot.id");
/**
 ...
 */
export const Priority = newAttribute("label.activity.priority");
/**
 ...
 */
export const Region = newAttribute("label.owner.region");
/**
 ...
 */
export const Sort = newAttribute("label.hardwaretest.sort");
/**
 * Attribute Title: Stage History
 * Attribute ID: attr.stagehistory.id
 */
export const StageHistory = newAttribute("label.stagehistory.id");
/**
 ...
 */
export const Status = newAttribute("label.activity.status");
/**
 * Attribute Title: Status
 * Attribute ID: attr.stage.status
 */
export const Status_1 = newAttribute("label.stage.status");
/**
 * Metric Title: _Snapshot [EOP]
 * Metric ID: abxgDICQav2J
 * Metric Type: MAQL Metric
 */
export const SnapshotEOP = newMeasure(idRef("abxgDICQav2J", "measure"));
/**
 * Metric Title: _Timeline [EOP]
 * Metric ID: abYgDBRagANw
 * Metric Type: MAQL Metric
 */
export const TimelineEOP = newMeasure(idRef("abYgDBRagANw", "measure"));
/**
 * Metric Title: # Of Opportunities
 * Metric ID: abQgDWx4gOUu
 * Metric Type: MAQL Metric
 */
export const NrOfOpportunities = newMeasure(idRef("abQgDWx4gOUu", "measure"));
/**
 * Metric Title: # Of Opportunities Won
 * Metric ID: aa4gLlQhcmLO
 * Metric Type: MAQL Metric
 */
export const NrOfOpportunitiesWon = newMeasure(idRef("aa4gLlQhcmLO", "measure"));
/**
 * Metric Title: Amount
 * Metric ID: aangOxLSeztu
 * Metric Type: MAQL Metric
 */
export const Amount = newMeasure(idRef("aangOxLSeztu", "measure"));
/**
 * Metric Title: Intermediate Sum Velocity and Value
 * Metric ID: ab8s8km1dcwm
 * Metric Type: MAQL Metric
 */
export const IntermediateSumVelocityAndValue = newMeasure(idRef("ab8s8km1dcwm", "measure"));
/**
 * Metric Title: Negative Sum Duration
 * Metric ID: abTsUy7k6OIl
 * Metric Type: MAQL Metric
 */
export const NegativeSumDuration = newMeasure(idRef("abTsUy7k6OIl", "measure"));
/**
 * Metric Title: Negative Sum Probability
 * Metric ID: acEsTPZKdqzb
 * Metric Type: MAQL Metric
 */
export const NegativeSumProbability = newMeasure(idRef("acEsTPZKdqzb", "measure"));
/**
 * Metric Title: Probability
 * Metric ID: abEgMnq5hyJQ
 * Metric Type: MAQL Metric
 */
export const Probability = newMeasure(idRef("abEgMnq5hyJQ", "measure"));
/**
 * Metric Title: Sample XIRR
 * Metric ID: aadpHDMBecIy
 * Metric Type: MAQL Metric
 */
export const SampleXIRR = newMeasure(idRef("aadpHDMBecIy", "measure"));
/**
 * Metric Title: Total Sum
 * Metric ID: aaKtfN0bAQyc
 * Metric Type: MAQL Metric
 */
export const TotalSum = newMeasure(idRef("aaKtfN0bAQyc", "measure"));
/**
 * Metric Title: Win Rate
 * Metric ID: abZgFKGPaGYM
 * Metric Type: MAQL Metric
 */
export const WinRate = newMeasure(idRef("abZgFKGPaGYM", "measure"));
/**
 * Metric Title: Won
 * Metric ID: acugFHNJgsBy
 * Metric Type: MAQL Metric
 */
export const Won = newMeasure(idRef("acugFHNJgsBy", "measure"));
/**
