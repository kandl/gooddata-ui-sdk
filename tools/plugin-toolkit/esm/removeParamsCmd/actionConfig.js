...
export async function getRemovePluginParamsCmdConfig(identifier, options) {
    var _a, _b, _c;
    ...
    const config = Object.assign(Object.assign({}, workspaceTargetConfig), { identifier,
        dashboard, dryRun: (_c = options.commandOpts.dryRun) !== null && _c !== void 0 ? _c : false, backendInstance });
    await doAsyncValidations(config);
    const originalParameters = await getOriginalParameters(config);
    if (isEmpty(originalParameters === null || originalParameters === void 0 ? void 0 : originalParameters.trim())) {
