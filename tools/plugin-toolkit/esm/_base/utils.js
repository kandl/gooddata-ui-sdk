 ...
 */
export function convertToPluginIdentifier(name) {
 ...
 */
export function convertToPluginDirectory(name) {
 ...
 */
export function convertToPluginEntrypoint(pluginIdentifier) {
 ...
 */
export function discoverBackendType(packageJson) {
...
export function genericErrorReporter(error) {
    ...
    if (isInputValidationError(error)) {
        ...
        if (((_a = e.message) === null || _a === void 0 ? void 0 : _a.search(/.*(certificate|self-signed).*/)) > -1) {
