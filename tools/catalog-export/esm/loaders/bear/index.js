 ...
 */
export async function loadWorkspaceMetadataFromBear(config) {
    ...
    try {
        ...
        throw new CatalogExportError(`Unable to obtain project metadata from platform. The error was: ${err}`, 1);
    }
}
