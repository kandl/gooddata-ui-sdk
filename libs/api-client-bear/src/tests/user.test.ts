    ...
    describe("with fake server", () => {
        ...
        describe("login", () => {
            it("resolves with userLogin using valid credential", () => {
                fetchMock.post("/gdc/account/login", {
                    status: 200,
                    body: JSON.stringify({
            ...
            it("rejects with bad credentials", () => {
                expect.assertions(1);
                fetchMock.post("/gdc/account/login", 400);
        ...
        describe("loginSso", () => {
            it("should resolve if user logged in", () => {
                ...
                fetchMock.mock("/gdc/account/customerlogin", 200);
        ...
        describe("isLoggedIn", () => {
            ...
            it("should resolve with false if user not logged in", () => {
                expect.assertions(1);
                fetchMock.mock("/gdc/account/token", 401);
        ...
        describe("isLoggedInProject", () => {
            it("should resolve true if user logged in and project is available", () => {
                ...
                fetchMock.mock("/gdc/account/profile/current", {
                    status: 200,
                    body: JSON.stringify({
                        accountSetting: {
                            links: {
                ...
                fetchMock.mock(`/gdc/account/profile/${profileId}/projects?offset=0&limit=100`, {
                    status: 200,
                    body: JSON.stringify({
                        projects: {
                            paging: {
