            ...
            const definitions = [
                ...
                },
                {
                    metricDefinition: {
                        ...
                        expression:
                            "SELECT (SELECT {fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.sum.7537800b1daf7582198e84ca6205d600}) / (SELECT {fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.sum.7537800b1daf7582198e84ca6205d600} BY ALL [/gdc/md/qamfsd9cw85e53mcqs74k8a0mwbf5gc2/obj/1027])",
                        format: "#,##0.00%",
                    },
                },
            ];
            ...
            const definitions = [
                {
                    metricDefinition: {
                        ...
                        expression:
                            "SELECT (SELECT {fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.percent.49a4394f29b465c3d494ead9ef09732d}) FOR PREVIOUS ([/gdc/md/qamfsd9cw85e53mcqs74k8a0mwbf5gc2/obj/1233])",
                        format: "#,##0.00%",
                    },
                },
                {
                ...
                },
                {
                    metricDefinition: {
                        ...
                        expression:
                            "SELECT (SELECT {fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.sum.7537800b1daf7582198e84ca6205d600}) / (SELECT {fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.sum.7537800b1daf7582198e84ca6205d600} BY ALL [/gdc/md/qamfsd9cw85e53mcqs74k8a0mwbf5gc2/obj/1233])",
                        format: "#,##0.00%",
                    },
                },
            ];
            ...
            const definitions = [
                {
                    metricDefinition: {
                        ...
                        identifier:
                            "fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.pop.8802950f69a83c21a5ae38f306148a02",
                        expression:
                            "SELECT (SELECT {metric-that-does-not-exist}) FOR PREVIOUS ([/gdc/md/qamfsd9cw85e53mcqs74k8a0mwbf5gc2/obj/1233])",
                        format: "#,##0.00%",
                    },
                },
                {
