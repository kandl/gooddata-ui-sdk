                                    ...
                                    filters: [
                                        {
                                            positiveAttributeFilter: {
                                                ...
                                                in: ["/gdc/md/FoodMartDemo/obj/58/elements?id=1000"],
                                            },
                                        },
                                    ],
                                },
...
export const requestForMeasureTypeFactWithFilter = {
    catalogRequest: {
        ...
        bucketItems: [
            "SELECT SUM([/gdc/md/FoodMartDemo/obj/1]) WHERE [/gdc/md/FoodMartDemo/obj/58] IN ([/gdc/md/FoodMartDemo/obj/58/elements?id=1000])", // tslint:disable-line:max-line-length
        ],
        requiredDataSets: {
            type: "PRODUCTION",
        },
...
export const requestForMeasureWithFilterAndCategoryShowInPercent = {
    catalogRequest: {
        ...
        bucketItems: [
            "/gdc/md/FoodMartDemo/obj/54",
            "SELECT (SELECT SUM([/gdc/md/FoodMartDemo/obj/1]) WHERE [/gdc/md/FoodMartDemo/obj/58] IN ([/gdc/md/FoodMartDemo/obj/58/elements?id=1000])) / (SELECT SUM([/gdc/md/FoodMartDemo/obj/1]) BY ALL [/gdc/md/FoodMartDemo/obj/54] WHERE [/gdc/md/FoodMartDemo/obj/58] IN ([/gdc/md/FoodMartDemo/obj/58/elements?id=1000]))", // tslint:disable-line:max-line-length
        ],
        requiredDataSets: {
            type: "PRODUCTION",
        },
                                    ...
                                    filters: [
                                        {
                                            negativeAttributeFilter: {
                                                ...
                                                notIn: ["/gdc/md/FoodMartDemo/obj/58/elements?id=1000"],
                                            },
                                        },
                                    ],
                                    computeRatio: true,
...
export const requestForMeasureWithShowInPercent = {
    catalogRequest: {
        ...
        bucketItems: [
            "/gdc/md/FoodMartDemo/obj/54",
            "SELECT (SELECT SUM([/gdc/md/FoodMartDemo/obj/1]) WHERE [/gdc/md/FoodMartDemo/obj/58] IN ([/gdc/md/FoodMartDemo/obj/58/elements?id=1000])) " + // tslint:disable-line:max-line-length
                "/ (SELECT SUM([/gdc/md/FoodMartDemo/obj/1]) BY ALL [/gdc/md/FoodMartDemo/obj/54] WHERE [/gdc/md/FoodMartDemo/obj/58] IN ([/gdc/md/FoodMartDemo/obj/58/elements?id=1000]))", // tslint:disable-line:max-line-length
        ],
        requiredDataSets: {
            type: "PRODUCTION",
        },
...
export const requestForMetric = {
    catalogRequest: {
        ...
        bucketItems: ["/gdc/md/FoodMartDemo/obj/8349"],
        requiredDataSets: {
            type: "PRODUCTION",
        },
    },
                ...
                availableDateAttributes: [
                    ...
                    },
                    {
                        attributeMeta: {
                            ...
                            summary:
                                "Week/Year based on EU Weeks (Mon-Sun). By default, if a week spans multiple years or quarters (ie, end of the year/quarter), it is marked as first or last week of the period according to particular standards (ie, US or EU). Labels marked as 'Continuous' show both weeks (W53/2009 - W1/2010).", // tslint:disable-line:max-line-length
                            isProduction: 0,
                            unlisted: 0,
                            category: "attribute",
                            updated: "2016-06-01 11:08:55",
