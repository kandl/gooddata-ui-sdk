...
import {
    ...
    IDrillUrlTarget,
    IDrillDashboardTarget,
    IDrillVisualizationTarget,
    IDrillToCustomUrlConfig,
    IDrillToAttributeUrlConfig,
    IDrillToUrlConfig,
    AttributeDisplayFormType,
} from "../../../interfaces";
import { newInsight } from "./insightMocks";
import { IAttributeDisplayForm, AttributeDisplayFormsMap } from "../../../interfaces";
...
export const drillVisualizationTarget: IDrillVisualizationTarget = {
    insight: newInsight("local:table", (m) =>
        m.uri("/gdc/mockproject/obj/123").identifier("visualization123").title("My visualization"),
    ),
};

export const drillDashboardTarget: IDrillDashboardTarget = {
    dashboard: idRef("123"),
};

export const drillCustomUrlTarget: IDrillUrlTarget = {
    urlDrillTarget: {
        customUrl: "https://gooddata.com",
    },
};

export const drillAttributeUrlTarget: IDrillUrlTarget = {
    urlDrillTarget: {
        insightAttributeDisplayForm: {
            uri: "/gdc/mockproject/obj/10",
        },
...
export const attributeDisplayFormsMap: AttributeDisplayFormsMap = {
    "/gdc/mockproject/obj/2": [countryAttributeDisplayForm],
};
