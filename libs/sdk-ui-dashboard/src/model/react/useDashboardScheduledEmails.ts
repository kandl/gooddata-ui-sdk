...
import { IOrganizationUser, ObjRef, IAutomationMdObject } from "@gooddata/sdk-model";
...
export const useDashboardScheduledEmails = () => {
    ...
    const [scheduledEmailToEdit, setScheduledEmailToEdit] = useState<IAutomationMdObject>();
    ...
    const onScheduleEmailingManagementEdit = useCallback(
        (schedule: IAutomationMdObject, users: IOrganizationUser[]) => {
            closeScheduleEmailingManagementDialog();
