...
export type DashboardCommandType =
    ...
    | "GDC.DASH/CMD.DRILL.PERFORM.DRILL_DOWN"
    | "GDC.DASH/CMD.DRILL.PERFORM.DRILL_TO_INSIGHT"
    | "GDC.DASH/CMD.DRILL.PERFORM.DRILL_TO_DASHBOARD"
    | "GDC.DASH/CMD.DRILL.PERFORM.DRILL_TO_ATTRIBUTE_URL"
    | "GDC.DASH/CMD.DRILL.PERFORM.DRILL_TO_CUSTOM_URL"
    | "GDC.DASH/CMD.DRILL.PERFORM.DRILL_TO_LEGACY_DASHBOARD";
