...
import { IOrganizationUser, IAutomationMdObject } from "@gooddata/sdk-model";
...
export const ScheduledEmailManagementDialog: React.FC<IScheduledEmailManagementDialogProps> = (props) => {
    ...
    const [scheduledEmailToDelete, setScheduledEmailToDelete] = useState<IAutomationMdObject | null>(null);
    const [isLoading, setIsLoading] = useState(true);
    const [scheduledEmailsByUser, setScheduledEmailsByUser] = useState<IAutomationMdObject[]>([]);
    const [scheduledEmails, setScheduledEmails] = useState<IAutomationMdObject[]>([]);
    ...
    const handleScheduleDelete = useCallback((scheduledEmail: IAutomationMdObject) => {
        setScheduledEmailToDelete(scheduledEmail);
    }, []);

    const handleScheduleEdit = useCallback(
        (scheduledEmail: IAutomationMdObject, users: IOrganizationUser[]) => {
