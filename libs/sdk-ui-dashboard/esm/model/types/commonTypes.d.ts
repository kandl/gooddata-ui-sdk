...
import { IColorPalette, ObjRef, IDateFilterConfig, IDashboard, ISettings, ISeparators, IEntitlementDescriptor } from "@gooddata/sdk-model";
 ...
 */
export declare function isResolvedConfig(config?: DashboardConfig): config is ResolvedDashboardConfig;
/**
 * @public
 */
