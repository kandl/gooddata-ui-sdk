import { IInsight, ObjRef, VisualizationProperties, IDashboardAttributeFilter, DrillDefinition, IInsightWidget, IInsightWidgetDefinition, ICatalogDateDataset, IInsightWidgetConfiguration } from "@gooddata/sdk-model";
...
export declare function insightWidgetDescriptionChanged(ctx: DashboardContext, ref: ObjRef, description: WidgetDescription, correlationId?: string): DashboardInsightWidgetDescriptionChanged;
/**
...
export declare function insightWidgetVisConfigurationChanged(ctx: DashboardContext, ref: ObjRef, newConfig: IInsightWidgetConfiguration | undefined, oldConfig: IInsightWidgetConfiguration | undefined, correlationId?: string): DashboardInsightWidgetVisConfigurationChanged;
/**
 ...
 * @beta
 */
export declare function insightWidgetExportResolved(ctx: DashboardContext, result: IExportResult, correlationId?: string): DashboardInsightWidgetExportResolved;
/**
 ...
 * @beta
 */
export declare function insightWidgetRefreshed(ctx: DashboardContext, insight: IInsight, correlationId?: string): DashboardInsightWidgetRefreshed;
/**
