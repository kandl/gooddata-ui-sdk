export declare const accessibleDashboardsSliceReducer: import("@reduxjs/toolkit").Reducer<import("@reduxjs/toolkit").EntityState<import("@gooddata/sdk-model").IListedDashboard>>;
