 ...
 * @internal
 */
export function addCssToStylesheet(sheetId, rules, clear = false) {
    const stylesNode = document.createTextNode(rules);
    let exStyleSheet = document.getElementById(sheetId);
    // clear stylesheet
...
//# sourceMappingURL=addCssToStylesheet.js.map