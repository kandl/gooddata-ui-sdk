 ...
 * @internal
 */
const addUTMParameters = (baseUrl, utmContent) => `${baseUrl}${baseUrl.includes("?") ? "&" : "?"}utm_medium=platform&utm_source=product&utm_content=${utmContent}`;
/**
 * @internal
 */
export function generateHeaderStaticHelpMenuItems(documentationUrl, communityUrl, universityUrl, slackUrl) {
    ...
    const documentationLink = documentationUrl || "https://www.gooddata.com/developers/cloud-native/doc/hosted/";
    return [
        {
            key: "gs.header.slack",
            className: "s-slack",
...
//# sourceMappingURL=generateHeaderStaticHelpMenuItems.js.map