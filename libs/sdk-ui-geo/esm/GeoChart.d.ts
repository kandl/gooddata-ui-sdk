...
import { AttributeOrPlaceholder, IDrillEventContext, ISeparators, IVisualizationCallbacks, IVisualizationProps, AttributeMeasureOrPlaceholder, NullableFiltersOrPlaceholders, SortsOrPlaceholders } from "@gooddata/sdk-ui";
 ...
 * @internal
 */
export declare function isGeoPushpinChartProps(props: GeoPushpinChartPropsUnion): props is IGeoPushpinChartProps;
/**
 * @internal
 */
export declare function isGeoPushpinChartLatitudeLongitudeProps(props: GeoPushpinChartPropsUnion): props is IGeoPushpinChartLatitudeLongitudeProps;
/**
 * @public
 */
