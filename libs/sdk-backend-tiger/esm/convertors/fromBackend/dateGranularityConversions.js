 ...
 */
const TigerToSdkGranularityMap = {
 ...
 */
export function toSdkGranularity(granularity) {
    return TigerToSdkGranularityMap[granularity];
}
const SdkToTigerGranularityMap = {
 ...
 */
export function toTigerGranularity(granularity) {
...
//# sourceMappingURL=dateGranularityConversions.js.map