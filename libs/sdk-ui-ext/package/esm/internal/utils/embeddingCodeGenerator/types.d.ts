 ...
 */
export type PropsWithMeta<TProps> = {
    [K in keyof TProps]: PropWithMeta<TProps[K]>;
};
/**
 * Function that converts a given insight in a given context to a props object for some visualization.
 */
export type InsightToPropsConverter<TProps> = (insight: IInsightDefinition, ctx?: IEmbeddingCodeContext) => PropsWithMeta<TProps>;
/**
