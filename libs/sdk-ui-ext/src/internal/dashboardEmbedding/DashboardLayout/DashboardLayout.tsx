    ...
    return (
        <FluidLayout
            ...
            rowRenderer={(renderProps) =>
                rowRenderer({ ...renderProps, debug, defaultRenderer: DashboardLayoutRowRenderer })
            }
            ...
            columnRenderer={(renderProps) =>
                columnRenderer({ ...renderProps, debug, defaultRenderer: DashboardLayoutColumnRenderer })
            }
