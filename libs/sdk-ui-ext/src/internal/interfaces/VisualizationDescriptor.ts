...
export interface IVisualizationDescriptor {
     ...
     *
     * @param insight {@link IInsight} to be used for the the drill down application
     * @param drillDownContext drill down configuration used to properly create the result
     * @returns {@link IInsight} with modified buckets and filters according to the provided drill down context.
     */
