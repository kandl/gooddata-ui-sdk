    ...
    renderConfigurationPanel() {
        ...
        return (React.createElement(BubbleHoverTrigger, { showDelay: SHOW_DELAY_DEFAULT, hideDelay: HIDE_DELAY_DEFAULT },
            React.createElement("div", null,
                featureFlags.enablePivotTableTransposition ? (React.createElement(MetricsPositionControl, { isDisabled: metricPositionControlsDisabled, showDisabledMessage: metricPositionControlsDisabled ? !isLoading : false, properties: properties, pushData: pushData })) : null,
                featureFlags.enablePivotTableTransposition &&
                    featureFlags.enableColumnHeadersPosition ? (React.createElement(ColumnHeadersPositionControl, { isDisabled: columnHeadersControlsDisabled, showDisabledMessage: columnHeadersControlsDisabled ? !isLoading : false, properties: properties, pushData: pushData, insight: insight })) : null),
...
//# sourceMappingURL=PivotTableConfigurationPanel.js.map