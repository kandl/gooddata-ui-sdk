 ...
 * @alpha
 */
export class FluidLayoutRowsMethods<
    TContent,
...
> implements IFluidLayoutRowsMethods<TContent, TColumn, TRow> {
    protected constructor(protected readonly _layoutFacade: IFluidLayoutFacade<TContent, TColumn, TRow>) {}
    ...
    ): FluidLayoutRowsMethods<TContent, TColumn, TRow> {
