import { IAttributeDescriptor, IResultAttributeHeader, ITotalDescriptor, IMeasureDescriptor } from "@gooddata/sdk-model";
...
export declare const ColumnGroupingDescriptorId = "root";
/**
 ...
 */
export type TableColType = "sliceCol" | "sliceMeasureCol" | "mixedValuesCol" | "mixedHeadersCol" | "seriesCol" | "scopeCol" | "rootCol";
/**
...
export declare function isSliceCol(obj: unknown): obj is SliceCol;
/**
...
export declare function isSliceMeasureCol(obj: unknown): obj is SliceMeasureCol;
export declare function isMixedHeadersCol(obj: unknown): obj is MixedHeadersCol;
export declare function isMixedValuesCol(obj: unknown): obj is MixedValuesCol;
/**
...
export declare function isSeriesCol(obj: unknown): obj is SeriesCol;
/**
...
export declare function isScopeCol(obj: unknown): obj is ScopeCol;
/**
 ...
 */
export declare function isEmptyScopeCol(col: AnyCol): boolean;
/**
...
export declare function isRootCol(obj: unknown): obj is RootCol;
/**
 ...
 */
export declare function agColId(colOrId: string | ColDef | ColGroupDef | Column): string;
//# sourceMappingURL=tableDescriptorTypes.d.ts.map