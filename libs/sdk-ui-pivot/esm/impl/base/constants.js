...
export const AVAILABLE_TOTALS = ["sum", "max", "min", "avg", "med", "nat"];
export const COLS_PER_PAGE = 1000;
...
export const DEFAULT_SUBTOTAL_FONT = '700 12px / 26px gdcustomfont, avenir, "Helvetica Neue", arial, sans-serif';
