 ...
 * @internal
 */
export declare function withExecutionLoading<TProps>(params: IWithExecutionLoading<TProps>): (WrappedComponent: React.ComponentType<TProps & WithLoadingResult>) => React.ComponentClass<TProps>;
