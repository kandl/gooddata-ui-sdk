...
import comboChartScenarios from "../../../scenarios/charts/comboChart/index.js";
...
describe(Chart, () => {
    const Scenarios: Array<ScenarioAndDescription<IComboChartProps>> = flatMap(comboChartScenarios, (group) =>
