...
const legendScenarios = scenariosFor("BulletChart", BulletChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "legend position" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("legend position", BulletChartWithAllMeasuresAndViewBy, legendCustomizer);
const dataLabelScenarios = scenariosFor("BulletChart", BulletChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "data labels" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("data labels", BulletChartWithAllMeasuresAndViewBy, dataLabelCustomizer);
const legendResponziveScenarios = responsiveScenarios("BulletChart", ScenarioGroupNames.LegendResponsive, BulletChart, BulletChartWithAllMeasuresAndViewBy, legendResponsiveSizeVariants, false, legendResponsiveVariants);
