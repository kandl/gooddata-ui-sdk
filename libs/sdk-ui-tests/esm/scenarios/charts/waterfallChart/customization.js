...
import { legendForceEnabledResponsiveVariants, legendResponsiveSizeVariants, } from "../_infra/legendResponsiveVariants.js";
import { extendedDataLabelCustomizer } from "../_infra/extendedDataLabelVariants.js";
const legendScenarios = scenariosFor("WaterfallChart", WaterfallChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "legend position" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("legend position", WaterfallChartWithMultiMeasures, legendForceEnabledCustomizer);
const dataLabelScenarios = scenariosFor("WaterfallChart", WaterfallChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "data labels" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("data labels", WaterfallChartWithMultiMeasures, extendedDataLabelCustomizer);
const legendResponziveScenarios = responsiveScenarios("WaterfallChart", ScenarioGroupNames.LegendResponsive, WaterfallChart, {
...
}, legendResponsiveSizeVariants, false, legendForceEnabledResponsiveVariants);
const totalConfigScenarios = scenariosFor("WaterfallChart", WaterfallChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
...
const orientationConfigScenarios = scenariosFor("WaterfallChart", WaterfallChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
