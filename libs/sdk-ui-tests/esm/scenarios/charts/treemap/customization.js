...
const legendScenarios = scenariosFor("Treemap", Treemap)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "legend position" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("legend position", TreemapWithMeasureViewByAndSegmentBy, legendCustomizer);
const dataLabelScenarios = scenariosFor("Treemap", Treemap)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "data labels" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("data labels", TreemapWithMeasureViewByAndSegmentBy, dataLabelCustomizer);
const legendResponziveScenarios = responsiveScenarios("Treemap", ScenarioGroupNames.LegendResponsive, Treemap, TreemapWithMeasureViewByAndSegmentBy, legendResponsiveSizeVariants, false, legendResponsiveVariants);
