...
const axisConfig = scenariosFor("LineChart", LineChart)
...
const singleAxisNameScenarios = scenariosFor("LineChart", LineChart)
    .withGroupNames(...ScenarioGroupNames.Axes)
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
...
const dualAxisNameScenarios = scenariosFor("LineChart", LineChart)
    .withGroupNames(...ScenarioGroupNames.Axes)
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .withVisualTestConfig({ groupUnder: "dual axis name configuration" })
    .addScenarios("dual axis name configuration", {
    ...LineChartTwoMeasuresWithTrendyBy,
    config: {
        secondary_yaxis: {
