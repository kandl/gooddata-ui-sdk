...
import { Headline, CalculateAs, ComparisonPositionValues, } from "@gooddata/sdk-ui-charts";
import { modifyMeasure } from "@gooddata/sdk-model";
import { scenariosFor } from "../../../src/index.js";
const amountCustomIdentifier = modifyMeasure(ReferenceMd.Amount, (m) => m.alias("Custom Amount").localId("custom_amount_local_id"));
const comparisonCustomPalette = [
    {
        guid: "positive",
        fill: {
            r: 195,
...
export const comparisonDisabled = {
    enabled: false,
};
export default scenariosFor("Headline", Headline)
