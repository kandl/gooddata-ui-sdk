...
const legendScenarios = scenariosFor("DonutChart", DonutChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "legend position" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("legend position - two measures", DonutChartWithTwoMeasures, legendCustomizer)
    .addScenarios("legend position - single measure and viewBy", DonutChartWithSingleMeasureAndViewBy, legendCustomizer);
const dataLabelScenarios = scenariosFor("DonutChart", DonutChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
    .withVisualTestConfig({ groupUnder: "data labels" })
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
    .addScenarios("data labels", DonutChartWithSingleMeasureAndViewBy, dataLabelCustomizer);
const chartAlignmentScenarios = scenariosFor("DonutChart", DonutChart)
    .withGroupNames(ScenarioGroupNames.ConfigurationCustomization)
...
const legendResponziveScenarios = responsiveScenarios("DonutChart", ScenarioGroupNames.LegendResponsive, DonutChart, DonutChartWithSingleMeasureAndViewBy, legendResponsiveSizeVariants, false, legendResponsiveVariants);
