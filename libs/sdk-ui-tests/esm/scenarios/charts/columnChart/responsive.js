...
const complexCcenarios = responsiveScenarios("ColumnChart", ScenarioGroupNames.Responsive, ColumnChart, {
    ...ColumnChartWithArithmeticMeasuresAndViewBy,
    config: { enableCompactSize: true, legend: { enabled: false } },
}, sizeVariantsComplex, false);
