...
import { BarChartWithSingleMeasureAndTwoViewByAndStack, BarChartWithSingleMeasureAndViewBy, BarChartWithTwoMeasuresAndTwoViewBy, } from "./base.js";
...
export default scenariosFor("BarChart", BarChart)
    ...
    drillableItems: [AttributeElements.Product.Explorer],
}, (m) => m.withTests("api")); // TODO: RAIL-2721 flaky test removed from screenshoting
