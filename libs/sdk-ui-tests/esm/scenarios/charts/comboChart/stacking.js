...
import { ComboChartWithArithmeticMeasuresAndViewBy, ComboChartWithManyPrimaryAndSecondaryMeasuresAndViewBy, ComboChartWithTwoSecondaryMeasures, } from "./base.js";
 ...
 */
const stackMeasuresDiffCharts = scenariosFor("ComboChart", ComboChart)
...
const stackMeasuresToPercentDiffCharts = scenariosFor("ComboChart", ComboChart)
    .withGroupNames(ScenarioGroupNames.Stacking)
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
...
const stackMeasuresBothChartsColumn = scenariosFor("ComboChart", ComboChart)
    .withGroupNames(ScenarioGroupNames.Stacking)
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
...
const discardStacking = scenariosFor("ComboChart", ComboChart)
    .withGroupNames(ScenarioGroupNames.Stacking)
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
...
const discardStackingWhenNoPrimary = scenariosFor("ComboChart", ComboChart)
    .withGroupNames(ScenarioGroupNames.Stacking)
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
...
const stackingWithoutDualAxis = scenariosFor("ComboChart", ComboChart)
    .withGroupNames(ScenarioGroupNames.Stacking)
    .withDefaultTags("vis-config-only", "mock-no-scenario-meta")
