...
const MeasureWithCustomFormat = modifyMeasure(ReferenceMd.Amount, (m) => m.format("[backgroundColor=ffff00][green]#,##0.00 €").defaultLocalId());
export default scenariosFor("PivotTable", PivotTable)
    ...
    .addScenario("measure format with colors", {
    ...PivotTableWithSingleMeasureAndTwoRowsAndCols,
